...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        className={cn(
        "z-50 max-h-(--radix-dropdown-menu-content-available-height) min-w-[12rem] origin-(--radix-dropdown-menu-content-transform-origin) overflow-x-hidden overflow-y-auto rounded-md border border-zinc-200 bg-white p-1 text-zinc-900 shadow-md data-[state=open]:animate-[dropdown-in_140ms_ease-out] data-[state=closed]:animate-[dropdown-out_110ms_ease-in]",
        className,
      )}
      {...props}
    />
