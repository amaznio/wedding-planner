    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          className="w-(--sidebar-width) bg-oklch(0.985 0 0) p-0 text-oklch(0.141 0.005 285.823) [&>button]:hidden dark:bg-oklch(0.21 0.006 285.885) dark:text-oklch(0.985 0 0)"
          style={
            {
    ...
    >
      ...
      >
        <div
          ...
          className="flex h-full w-full flex-col bg-oklch(0.985 0 0) group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:border-oklch(0.92 0.004 286.32) group-data-[variant=floating]:shadow-sm dark:bg-oklch(0.21 0.006 285.885) dark:group-data-[variant=floating]:border-oklch(1 0 0 / 10%)"
        >
          {children}
        </div>
      </div>
...
function SidebarRail({ className, ...props }: React.ComponentProps<"button">) {
  ...
  return (
    <button
      ...
      className={cn(
        "absolute inset-y-0 z-20 hidden w-4 -translate-x-1/2 transition-all ease-linear group-data-[side=left]:-right-4 group-data-[side=right]:left-0 after:absolute after:inset-y-0 after:left-1/2 after:w-[2px] hover:after:bg-oklch(0.92 0.004 286.32) sm:flex dark:hover:after:bg-oklch(1 0 0 / 10%)",
        "in-data-[side=left]:cursor-w-resize in-data-[side=right]:cursor-e-resize",
        "[[data-side=left][data-state=collapsed]_&]:cursor-e-resize [[data-side=right][data-state=collapsed]_&]:cursor-w-resize",
        "group-data-[collapsible=offcanvas]:translate-x-0 group-data-[collapsible=offcanvas]:after:left-full hover:group-data-[collapsible=offcanvas]:bg-oklch(0.985 0 0) dark:hover:group-data-[collapsible=offcanvas]:bg-oklch(0.21 0.006 285.885)",
...
function SidebarInput({
  ...
  return (
    <Input
      ...
      data-sidebar="input"
      className={cn("h-8 w-full bg-oklch(1 0 0) shadow-none dark:bg-oklch(0.141 0.005 285.823)", className)}
      {...props}
    />
  )
}
...
function SidebarGroupLabel({
  ...
  return (
    <Comp
      ...
      className={cn(
        "flex h-8 shrink-0 items-center rounded-md px-2 text-xs font-medium text-oklch(0.141 0.005 285.823)/70 ring-oklch(0.705 0.015 286.067) outline-hidden transition-[margin,opacity] duration-200 ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0 dark:text-oklch(0.985 0 0)/70 dark:ring-oklch(0.552 0.016 285.938)",
  ...
  "peer/menu-button flex w-full items-center gap-2 overflow-hidden rounded-md p-2 text-left text-sm ring-oklch(0.705 0.015 286.067) outline-hidden transition-[width,height,padding] group-has-data-[sidebar=menu-action]/menu-item:pr-8 group-data-[collapsible=icon]:size-8! group-data-[collapsible=icon]:p-2! hover:bg-oklch(0.967 0.001 286.375) hover:text-oklch(0.21 0.006 285.885) focus-visible:ring-2 active:bg-oklch(0.967 0.001 286.375) active:text-oklch(0.21 0.006 285.885) disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-oklch(0.967 0.001 286.375) data-[active=true]:font-medium data-[active=true]:text-oklch(0.21 0.006 285.885) data-[state=open]:hover:bg-oklch(0.967 0.001 286.375) data-[state=open]:hover:text-oklch(0.21 0.006 285.885) [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0 dark:ring-oklch(0.552 0.016 285.938) dark:hover:bg-oklch(0.274 0.006 286.033) dark:hover:text-oklch(0.985 0 0) dark:active:bg-oklch(0.274 0.006 286.033) dark:active:text-oklch(0.985 0 0) dark:data-[active=true]:bg-oklch(0.274 0.006 286.033) dark:data-[active=true]:text-oklch(0.985 0 0) dark:data-[state=open]:hover:bg-oklch(0.274 0.006 286.033) dark:data-[state=open]:hover:text-oklch(0.985 0 0)",
  {
    variants: {
      variant: {
        ...
        outline:
          "bg-oklch(1 0 0) shadow-[0_0_0_1px_var(--sidebar-border)] hover:bg-oklch(0.967 0.001 286.375) hover:text-oklch(0.21 0.006 285.885) hover:shadow-[0_0_0_1px_var(--sidebar-accent)] dark:bg-oklch(0.141 0.005 285.823) dark:hover:bg-oklch(0.274 0.006 286.033) dark:hover:text-oklch(0.985 0 0)",
      },
      size: {
        default: "h-8 text-sm",
        sm: "h-7 text-xs",
